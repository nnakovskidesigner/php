<section class="formcarry-container">
  <form action="process.php" method="GET" enctype="multipart/form-data">
    ...
    <div class="formcarry-block">
      <label for="fc-generated-1-name">Vnesi prv broj za sobiranje</label>
      <input type="number" name="prvbrojsobiranje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">Vnesi vtor broj za sobiranje</label>
      <input type="number" name="vtorbrojsobiranje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <!-- mnozenje -->

    <div class="formcarry-block">
      <label for="fc-generated-1-name">prv broj mnozenje</label>
      <input type="number" name="prvbrojmnozenje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">prv broj mnozenje</label>
      <input type="number" name="vtorbrojmnozenje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <!-- odzemanje -->

    <div class="formcarry-block">
      <label for="fc-generated-1-name">prv broj odzemanje</label>
      <input type="number" name="prvbrojodzemanje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">vtor broj odzemanje</label>
      <input type="number" name="vtorbrojodzemanje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <!-- delenje -->

    <div class="formcarry-block">
      <label for="fc-generated-1-name">prv broj delenje</label>
      <input type="number" name="prvbrojdelenje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">vtor broj delenje</label>
      <input type="number" name="vtorbrojdelenje" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>
  	
    

    <!-- <div class="formcarry-block">
      <label for="fc-generated-1-name">Enter Temperature 1</label>
      <input type="number" name="temp1" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">Enter Temperature 2</label>
      <input type="number" name="temp2" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">Enter Temperature 3</label>
      <input type="number" name="temp3" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>

    <div class="formcarry-block">
      <label for="fc-generated-1-name">Enter Temperature 4</label>
      <input type="number" name="temp4" id="fc-generated-1-name" placeholder="Your first and last name" />
    </div>
